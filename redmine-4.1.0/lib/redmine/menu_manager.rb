...
#.............................................
      ...
      def render_menu_admin(menu, project=nil)
        links = []
        menu_items_for(menu, project) do |node|
          links << render_menu_admin_node(node, project)
        end
        links.empty? ? nil : content_tag('div class="admin-buttons"', links.join.html_safe)
      end

      def render_menu_admin_node(node, project=nil)
        if node.children.present? || !node.child_menus.nil?
          return render_menu_node_with_children(node, project)
        else
          caption, url, selected = extract_node_details(node, project)
          return content_tag('button class="button-admin"',
