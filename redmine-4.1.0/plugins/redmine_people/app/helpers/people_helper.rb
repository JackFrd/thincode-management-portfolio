...
module PeopleHelper
  ...
  def rate_to_currency(rate)
    price_to_currency(rate, RedminePeople.settings['rate_currency'], decimal_mark: RedmineCrm::Settings::Money.decimal_separator,
                                                                     delimiter: RedmineCrm::Settings::Money.thousands_delimiter)
  end
